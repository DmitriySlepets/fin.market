$(document).ready(function(){
	...
	function cardTypePosition() {
		$('.display_list .list_item').each(function (index) {
			var cardData = $(this).children('.card-data'),
				desktopPosition = $(this).children('.image_wrapper_block a'),
				mobilePosition = $(this).children('.description_wrapp');
